...
df = pd.read_csv('/home/ahmed/Pictures/cogedis/24072017/split/digit+char/ocr/ab+omni/digit+char_valid.csv')
df = df.astype(str)
df=df.ix[:,0:4]
...
df2.to_csv('/home/ahmed/Pictures/cogedis/24072017/split/digit+char/ocr/ab+omni/valid-digit+char_augmented.csv',sep=',',index=False)

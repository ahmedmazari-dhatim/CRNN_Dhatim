...
def val(net, dataset, criterion, max_iter=22):
    print('Start val')
...
for epoch in range(opt.niter):
    ...
    while i < len(train_loader):
        ...
        '''
        if i % plot_every == 0:
            dis_loss.append(total_loss /plot_every)
            total_loss = 0
        '''
    ...
    #plt.figure()
    #plt.plot(dis_loss)
    #plt.savefig('/home/ahmed/Pictures/cogedis/cogedis_words_3/loss.png')

...
df = pd.read_csv('/home/ahmed/Pictures/cogedis/data_crnn/test_digit_alpha.csv')
#df['crnn']=None
df = df.astype(str)
...
model_path='/home/ahmed/Pictures/model/print/netCRNN_64_65.pth'
...
for img in images_names:
    if img.rsplit('.',1)[0] in df.id.values:
        ...
        dl +=1
        if dl==1 :
            #print("lengthof preds is : ",len(preds))
            #print("predictions are : ",preds)
            #print("prediction max : ", preds.max(2))
        _, preds = preds.max(2)
...
df.to_csv('/home/ahmed/Pictures/cogedis/data_crnn/proba_ctc_alpha_digit.csv',sep=',')
